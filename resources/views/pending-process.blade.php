...
@section('title', '::.Process Pending Order')
@section('content')
            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <form action="{{url('pending/checkout/'.$order['id'])}}" method="post">
                        {{csrf_field()}}
                            <div class=" form-inline">
                                ...
                                @endif
                                <input class="input-sm" type="hidden" name="is_rgb" id="check-quantity-is-rgb" readonly="readonly" value="{{$order['is_rgb']}}" />
