...
<ul class="msg-list" id="msg-list-add-file">


</ul>
<div class="hypermedia pull-right" id="hypermedia-contacts">
</div>
                ...
                <div id="tab-3" class="tab-pane">
                    <div class="panel-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-modal-save pull-left" data-dismiss="modal" data-toggle="modal" data-target="#myModal" >CANCEL</button>
                            <button type="button" id="add-file-proceed" data-dismiss="modal" data-toggle="modal" data-target="#myModal" class="btn btn-danger btn-recharge">PROCEED</button>
                        </div>
                    <!--</form>-->
                    </div>
                </div>
