<div class="modal fade" id="deleteSentModal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <form method="post" id="compose-modal">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger btn-recharge" id="delete-sent-confirm"
